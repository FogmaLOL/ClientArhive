...
public class Ping100Crystal extends Module    {

    public DecimalSetting placeInterval = new DecimalSetting("Place Interval", 0, 0, 0, 0.1);
    public DecimalSetting breakInterval = new DecimalSetting("Break Interval", 0, 0, 0, 0.1);
    ...
    public Ping100Crystal() {
        super("Ping100Crystal", "cw", false,Category.COMBAT);
