...
public class CwCrystal extends Module   {
    ...
    public DecimalSetting placeInterval = new DecimalSetting("Place Interval", 0, 20, 0, 0.1);
    public DecimalSetting breakInterval = new DecimalSetting("Break Interval", 0, 20, 0, 0.1);
    public BooleanSetting activateOnRightClick = new BooleanSetting("On Right Click", false);
    ...
    public CwCrystal() {
        super("CwCrystal", "cw", false,Category.COMBAT);
        addSettings(placeInterval,breakInterval,activateOnRightClick,stopOnKill);
    }
