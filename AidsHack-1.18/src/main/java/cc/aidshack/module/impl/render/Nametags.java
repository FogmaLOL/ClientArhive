...
import cc.aidshack.utils.MathUtils;
import cc.aidshack.utils.RenderUtils;
import cc.aidshack.utils.Utils;
...
public class Nametags extends Module {
    ...
    public DecimalSetting scale = new DecimalSetting("Scale", 0.5, 5, 1.3, 0.01);
    public BooleanSetting bg = new BooleanSetting("Background", false);
    public BooleanSetting ping = new BooleanSetting("Ping", false);
    public BooleanSetting healthbar = new BooleanSetting("Healthbar", false);
    public BooleanSetting items = new BooleanSetting("Items", false);
    public BooleanSetting head = new BooleanSetting("Head", false);
    ...
    public Nametags() {
        super("Nametags", "Renders a custom nametag above players", false, Category.RENDER);
...
//            if (showInv)
    ...
    public String getNameString(Entity entity) {
        ...
        if (entity instanceof LivingEntity)
            displayName = gameModeText + ColorUtils.white + name.replaceAll(ColorUtils.colorChar, "&") + " " + pingText + distanceText + getHealthString((LivingEntity) entity) + (AidsHack.isAidsHackUser(entity.getName().asString()) ? ColorUtils.purple + " H" : "");
        return displayName;
    }
