...
public class AutoDtap extends Module
{
    ...
    private final DecimalSetting placeInterval = new DecimalSetting("Place Interval", 0, 20, 4, 1);
    private final DecimalSetting MaxCrystals = new DecimalSetting("Place Interval", 1, 2, 1, 1);
    private BooleanSetting activateOnRightClick = new BooleanSetting("Activate On RClick", false);
    private final DecimalSetting breakInterval = new DecimalSetting("Place Interval", 0, 20, 3, 1);

    public BooleanSetting stopOnKill = new BooleanSetting("Stop On Kill", false);
