package cc.aidshack.utils.font;
        ...
        try {
            if ((font instanceof Font))
                ...
                if (((String)font).toLowerCase().endsWith("ttf") || ((String)font).toLowerCase().endsWith("otf"))
                    this.theFont = Font.createFont(0, new File(AidsHack.aidsDir + File.separator + "fonts", (String)font)).deriveFont(size);
                else
                ...
                if (name.toLowerCase().endsWith("ttf") || name.endsWith("otf"))
                    this.theFont = Font.createFont(0, new File(AidsHack.aidsDir + File.separator + "fonts", name)).deriveFont(size);
                else
