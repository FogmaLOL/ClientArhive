...
import cc.aidshack.mixins.ClientPlayNetworkHandlerAccessor;
...
public class WorldChunkIterator implements Iterator<WorldChunk> {
    ...
    public static int getRenderDistance() {
        return Math.max(mc.options.getViewDistance(), ((ClientPlayNetworkHandlerAccessor) mc.getNetworkHandler()).getChunkLoadDistance());
    }
}
