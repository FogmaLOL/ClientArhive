...
public enum BlockUtils {
    ...
    public static boolean placeBlock(BlockPos pos, BlockState state) {
        ...
        final ActionResult result = MC.interactionManager.interactBlock(MC.player, MC.world, Hand.MAIN_HAND, new BlockHitResult(faceCenterToClick, directionToClick, neighborToClick, false));
    ...
    public static boolean rightClickBlock(BlockPos pos) {
        ...
        final ActionResult result2 = MC.interactionManager.interactBlock(MC.player, MC.world, Hand.MAIN_HAND, new BlockHitResult(hitVecs[side.ordinal()], side, pos, false));
